...
export default function App() {
  ...
  let schedule = []
  try {
    schedule = buildSchedule(attendance, sessions, teachers, statusOptions)
  } catch (error) {
    console.error(error)
  }
